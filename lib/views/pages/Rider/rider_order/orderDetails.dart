...
class RROrderDetails extends StatefulWidget {
  String price,
      name,
      date,
      id,
  ...
  @override
  _RROrderDetailsState createState() => _RROrderDetailsState();
}

class _RROrderDetailsState extends State<RROrderDetails> {
