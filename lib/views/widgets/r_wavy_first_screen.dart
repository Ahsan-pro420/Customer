...
class R_WavyHeaderImage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Stack(children: [
      ClipPath(
        ...
        clipper: R_BottomWaveClipper(),
      ),
      Positioned(
          top: displayHeight(context) / 2 * 0.1,
          left: displayWidth(context) / 2 * 0.4,
          child: Image(
              image: AssetImage('assets/r_assets/images/rider_logo.png'))),
      Positioned(
...
class R_BottomWaveClipper extends CustomClipper<Path> {
  @override
