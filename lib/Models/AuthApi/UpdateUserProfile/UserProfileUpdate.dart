...
class UpdateUserProfile {
  ...
  Future<UserUpdateData> apiCallUserUpdate(Map<String, dynamic> param) async {
    ...
    print(
        "https://portal.letsride.today/api/v1/customer/update-profile?api_token=/$_list.first");
    print({"name": _list[1], "email": _list[2]});
    String link = _list.first;

    // String bodyData = json.encode(param);
    var url = Uri.parse(
        "https://portal.letsride.today/api/v1/customer/update-profile?api_token=$link");
